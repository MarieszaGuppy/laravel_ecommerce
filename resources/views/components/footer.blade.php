    ...
    <footer class="pt-5">
        <div class="row px-3">
            <div class="col-6 col-md-2 mb-3">
                <h4 class="text-white">Toko</h4>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Lokasi</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Tentang Kami</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Hubungi Kami</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-md-2 mb-5">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Sale</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Koleksi Baru</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Kaos</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Hoodie</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Topi</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Aksesoris</a></li>
                </ul>
            </div>
        ...
        <div class="d-flex justify-content-center py-3 mt-4 border-top">
